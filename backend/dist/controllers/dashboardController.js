...
const Shipment_1 = require("../models/Shipment"); // Assuming IShipment has customerRate, carrierCostTotal
const Carrier_1 = require("../models/Carrier");
const Shipper_1 = require("../models/Shipper");
const logger_1 = require("../utils/logger");
const moment_1 = __importDefault(require("moment")); // For date manipulations
class DashboardController {
    ...
    async getKPIs(req, res) {
        ...
        try {
            ...
            const realizedShipmentStatuses = ['delivered', 'invoiced', 'paid'];
            ...
            const totalCarriers = await Carrier_1.Carrier.countDocuments({ isActive: true }); // Assuming an isActive field
